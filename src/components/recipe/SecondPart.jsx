    ...
    return (
        <div className="mb-20 lg:w-[80%]">
            <div className="w-full mt-10 lg:mt-0">
                ...
                <div className="my-8" ref={modePrepRef}>
                ...
                <div className="flex items-center my-7">
                    <div className="flex flex-col xl:flex-row xl:items-center  w-full text-[#5E5DC0]">
                        <label className="flex items-center text-[20px] lg:w-[20%] mb-4 xl:mb-0 ml-4">
                        ...
                        <input
                            ...
                            className="w-full appearance-none inputRange outline-none"
                        />
                    </div>
                </div>
