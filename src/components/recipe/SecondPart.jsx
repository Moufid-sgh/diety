...
const SecondPart = ({ ingredients, ustensiles, nbr_serves, sortedSteps }) => {
    ...
    const [portion, setPortion] = useState(nbr_serves);
    ...
    return (
        <div className="mb-20 lg:w-[80%]">
            <section className="w-full mt-10 lg:mt-0">
                <div className="flex items-center bg-[#F5F5F5] rounded-[10px] w-fit p-1 text-[18px] md:text-[22px]">
                    <div className="rounded-[12px] bg-blue text-white px-6 py-1.5 cursor-pointer">
                        القيم الغذائية
                    </div>
                    <div className="rounded-[12px] text-[#262F82BA] hover:text-white hover:bg-blue mx-4 px-6 py-1.5 cursor-pointer transition-all duration-300">
                        المكونات
                    </div>
                    <div
                        onClick={() => {
                        ...
                        className="rounded-[12px] text-[#262F82BA] px-6 py-1.5 hover:bg-blue hover:text-white transition-all duration-300cursor-pointer">
                        الطريقة
                    </div>
                </div>
                ...
                <div className="flex items-center my-7">
                    <div className="flex flex-col lg:flex-row lg:items-center w-full text-[#5E5DC0]">
                        ...
                        <input
                            ...
                            value={portion}
                            data-value={portion}
                            onChange={(e) => handlePersonsChange(parseInt(e.target.value) - portion)}
                            className="lg:w-[80%] appearance-none inputRange"
                        />
                    </div>
                </div>
