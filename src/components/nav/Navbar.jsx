...
const Navbar = () => {
  ...
  return (
    <nav dir="rtl">
      ...
      <div className="flex items-start justify-between px-3 md:px-8 lg:px-32 py-4  pt-8 z-50 fixed lg:relative top-0 left-0 right-0 bg-white shadow-sm lg:shadow-none">
        {/* for desktop--------------------------------------- */}
        <div className="hidden lg:flex flex-col">
          <Menu />
          <SearchBar />

          {!isFilterPage && <HeroSection />}

          {!isFilterPage && <div className='bg-blue rounded-[4px] w-fit px-5 py-1 hover:bg-[#007AFFCC] duration-300'>
